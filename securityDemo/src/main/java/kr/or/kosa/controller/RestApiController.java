...
회원가입완료
curl -v -X POST  -H "content-type: application/json" -d "{\"username\":\"masungil\",\"password\":\"1234\"}" http://localhost:8090/api/v1/join

로그인
curl -v -X POST  -d "{\"username\":\"masungil\",\"password\":\"1234\"}" http://localhost:8090/login

유저 혹은 매니저 혹은 어드민이 접근 가능
curl -v -H "Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJpZCI6MCwidXNlcm5hbWUiOiJtYXN1bmdpbCIsImV4cCI6MTY5MTI4MzEzOH0.eWxkI3A-ZUTjxCvG_IhzhDy5BNJyiX49wB7tPTxOEk0" http://localhost:8090/api/v1/user
*/
